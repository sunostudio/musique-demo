      ...
      <div className="container px-6 py-4 mx-auto ">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <Link
                to=""
                className="text-xl font-bold text-gray-700 dark:text-white hover:text-gray-700 dark:hover:text-gray-300"
              >
                Musique-demo
              </Link>

              <p className="max-w-md mt-2 text-gray-500 dark:text-gray-400">
                Join 31,000+ other and never miss out on new songs released by
                your favorite artists, new artists, and more.
              </p>

              <div className="flex mt-4 -mx-2">
                <a
                  href="/linkedin.com/musique-demo"
                ...
                <a
                  href="/facebook.com/musique-demo"
                  className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400"
                  aria-label="Facebook"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 512 512">
        ...
        <div>
          <p className="text-center text-gray-800 dark:text-white">
            &copy; Musique 2020 - {getYear()} All rights reserved
          </p>
        </div>
      </div>
    </footer>
