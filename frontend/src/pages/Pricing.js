              ...
              <div className="max-w-sm mx-auto border hover:bg-slate-900 rounded-lg md:mx-4 dark:border-gray-600">
                <div className="p-6 ">
                  ...
                  <h2 className="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">
                    $5.99 <span className="text-base font-medium">/Month</span>
                  </h2>
                  <p className="mt-1 text-gray-500 dark:text-gray-300">
                    Monthly payment
                  </p>
                  <button className="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-700 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                    Start Now
                  </button>
                </div>
